...
public interface ITenantModelConnectorService
{
    ...
    Task<IReadOnlyList<TenantModelConnectorAdminDto>> ListTenantConnectorsAsync(string tenantId, string? currentUserId = null, CancellationToken ct = default);
    Task<TenantModelConnectorAdminDto> CreateConnectorAsync(string tenantId, UpsertTenantModelConnectorRequest request, string? currentUserId = null, CancellationToken ct = default);
    Task<TenantModelConnectorAdminDto> UpdateConnectorAsync(string tenantId, string connectorId, UpsertTenantModelConnectorRequest request, string? currentUserId = null, CancellationToken ct = default);
    Task DeleteConnectorAsync(string tenantId, string connectorId, CancellationToken ct = default);
    Task<TenantModelConnectorAdminDto> SetDefaultConnectorAsync(string tenantId, string connectorId, string? currentUserId = null, CancellationToken ct = default);
